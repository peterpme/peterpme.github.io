...
type loadPagesQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly title: string | null } | null, readonly fields: { readonly slug: string | null } | null } }> } };
